...
def get_args():
    ...
    parser.add_argument("--experiment_name", type=str, default='ARL_train0')
    # 输入维度
    parser.add_argument("--in_dim_vehicle", type=int, default=10, help="自车信息")
    parser.add_argument("--in_dim_agents", type=int, default=11)
    parser.add_argument("--in_dim_static", type=int, default=10)
    ...
    parser.add_argument("--out_dim_lane", type=int, default=16)
    parser.add_argument("--out_dim_route", type=int, default=16)
    parser.add_argument("--feature_dim_agent", type=int, default=16)
    parser.add_argument("--out_dim_agent", type=int, default=32)
    parser.add_argument("--out_dim_static", type=int, default=8)
    ...
    parser.add_argument("--head_num_T", type=int, default=8)

    # 特征融合网络参数
    parser.add_argument("--hidden_dim_dense", type=int, default=128)
    parser.add_argument("--layer_num_dense", type=int, default=2)

    parser.add_argument("--hidden_dim_option", type=int, default=128)
    parser.add_argument("--layer_num_option", type=int, default=3)
    ...
    parser.add_argument("--hidden_dim_classify", type=int, default=64)
    parser.add_argument("--layer_num_classify", type=int, default=3)
    ...
    # 训练参数
    parser.add_argument('--save_every', default=20, type=int, help='每多少个epoch保存一次模型')
    parser.add_argument('--val_every', default=5, type=int, help='每多少个epoch评估一次模型')
    parser.add_argument('--total_epochs', default=500, type=int, help='总共训练多少个epoch')
    parser.add_argument('--critic_epochs', default=-1, type=int, help='总共训练多少个epoch')
    parser.add_argument('--batch_size', default=400, type=int, help='batch size')

    # 优化器参数，包括初始学习率,学习率衰减的epoch数,学习率衰减的gamma
    parser.add_argument('--bc_lr', default=0.0001, type=float, help='bc训练时的学习率')
    ...
    parser.add_argument("--tau", type=float, default=0.001, help="软更新参数")
    parser.add_argument("--gamma", type=float, default=0.9, help="折扣因子")
    parser.add_argument("--sync_freq", type=int, default=2, help="同步频率")
    parser.add_argument("--lr_actor", type=float, default=5e-5)
    parser.add_argument("--lr_critic", type=float, default=1e-4)
    parser.add_argument('--dropout', default=0.3, type=float)
    parser.add_argument('--norm_layers', default=0, type=int)
    parser.add_argument('--weight_decay', default=1e-4, type=float)

    # critic网络参数
    parser.add_argument("--critic1_hidden_dim", type=int, default=128)
    parser.add_argument("--critic1_layer_num", type=int, default=3)
    parser.add_argument("--critic2_hidden_dim", type=int, default=196)
    parser.add_argument("--critic2_layer_num", type=int, default=2)
